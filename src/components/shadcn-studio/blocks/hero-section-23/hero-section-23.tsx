...
const words = ['Erfolg', 'Deals', 'Wachstum']
          ...
          <div className='space-y-32 p-8'>
            <div className='flex flex-col justify-center gap-6 max-xl:items-center max-xl:text-center md:max-xl:mx-auto md:max-xl:max-w-150'>
              ...
              >
                ...
                <span className='text-muted-foreground'>Die #1 Cold Email Ressource im DACH-Raum</span>
              </MotionPreset>
              ...
              <MotionPreset fade slide={{ offset: 50 }} blur transition={{ duration: 0.5 }} delay={0.5}>
                <p className='text-muted-foreground text-xl'>
                  Kostenlose Kurse, bewährte Templates, praktische Tools und Schritt-für-Schritt Playbooks -
                  alles was du für erfolgreiche Cold Email Kampagnen brauchst.
                </p>
              </MotionPreset>
              <MotionPreset
                component='div'
              ...
              >
                ...
                <Button asChild variant='secondary' className='rounded-full text-base has-[>svg]:px-6' size='lg'>
                  <a href='/kurse'>
                    Kurse entdecken
                    <PlayIcon />
                  </a>
              ...
              >
                ...
                <div>
                  <p className='text-sm'>Von 12.000+ Nutzern bewertet</p>
                  <Rating
                    readOnly
                    variant='yellow'
                    size={24}
            ...
            <div className='space-y-3.5 px-4 py-2'>
              ...
              >
                Vertraut von Top-Unternehmen im DACH-Raum
              </MotionPreset>
              <MotionPreset
                fade
                slide={{ direction: 'down', offset: 50 }}
          ...
          <div ref={containerRef} className='relative flex flex-col items-center justify-center px-8'>
            ...
            <div className='mb-14 grid w-full grid-cols-1 gap-10 px-2 pt-2 max-xl:max-w-140 md:mb-7 md:grid-cols-2'>
              <div ref={cardRef1} className='relative'>
                <StatisticsCard
                  title='Response Rate'
                  badgeContent='Durchschnitt'
                  value='12.4%'
                  changePercentage='+520%'
