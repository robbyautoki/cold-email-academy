...
const features = [
  { img: <Users />, label: 'Sofortiger Zugang' },
  { img: <Medal />, label: 'Exklusive Inhalte' },
  { img: <Support />, label: '100% kostenlos' }
]
        ...
        <div className='flex flex-col items-center gap-8 text-center'>
          <div className='flex flex-col items-center gap-4 text-center'>
            <MotionPreset
              ...
              className='z-10'
            >
              <Badge className='text-sm font-normal'>Kostenloser Zugang</Badge>
            </MotionPreset>
            ...
            >
              Erhalte sofort Zugriff auf unsere exklusiven Inhalte, <br className='max-sm:hidden' /> Strategien und
              Tools – komplett kostenlos.
            </MotionPreset>
          </div>
          <MotionPreset
            component='div'
          ...
          >
            <Button asChild size='lg' className='h-12 px-8 text-base'>
              <Link href='/login'>Jetzt Zugang sichern</Link>
            </Button>
          </MotionPreset>
