...
const TOOL_NAMES: Record<string, string> = {
  ...
  'email-signatur': 'Email Signatur',
  'mx-record-check': 'MX Record Check',
  'email-verifizierung': 'Email Verifizierung',
  'dns-checker': 'DNS Checker',
  'email-kalkulator': 'Email Kalkulator',
  'blacklist-pruefer': 'Blacklist Prüfer'
}
...
export default function ToolsLayout({
  ...
  const toolName = TOOL_NAMES[toolSlug] || 'Tool'
